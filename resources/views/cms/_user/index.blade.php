                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                                <div class="form-group m-0">
                                    <div class="form-line">
                                        <input type="text" id="username" name="username" class="form-control fake"
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                                <div class="form-group m-0">
                                    <div class="form-line">
                                        <input type="text" id="userid" name="userid" class="form-control fake"
                                               value="{{request('userid') ?? old('userid')}}">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                                <div class="form-group m-0">
                                    <div class="form-line">
                                        <input type="text" id="phone" name="phone" class="form-control fake"
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
                                <div class="form-group m-0">
                                    <div class="form-line">
                                        <input type="text" id="email" name="email" class="form-control fake"
                            ...
                            @else @foreach($datas as $item)
                                <tr>
                                    ...
                                    <td>@if(isset($item->facebook_id))
                                            <a href="https://fb.com/{{$item->facebook_id}}" target="_blank">
                                                https://facebook.com/{{$item->facebook_id}}</a>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <a class="item-tool" title="Xem"
                                           href="{!! route('cms.user.show',['id'=>$item->global_user_id]) !!}">
